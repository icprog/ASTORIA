...
#ifndef TCP_MSIATTACKER_H
#define TCP_MSIATTACKER_H
...
class MSIAttacker : public ScadaApplication
{
public:
	MSIAttacker (Ptr<Socket> socket ,const Address &l, const Address &t, uint32_t nodeId, std::string nodeName,uint32_t interval,std::string Protocol, std::string serverName);
	virtual ~MSIAttacker();
